...
func BenchmarkJWE_Encrypt_HPKE(b *testing.B) {
	if testing.Short() {
		b.Skip("skipping in short mode")
	}

	// HPKE algorithms use ECDH keys for key encapsulation
	...
	testcases := []struct {
		...
		{"HPKE-0-KE/A256GCM", jwa.HPKE_0_KE(), jwa.A256GCM(), &ecKeyP256.PublicKey},
		{"HPKE-1-KE/A256GCM", jwa.HPKE_1_KE(), jwa.A256GCM(), &ecKeyP384.PublicKey},
		{"HPKE-2-KE/A256GCM", jwa.HPKE_2_KE(), jwa.A256GCM(), &ecKeyP521.PublicKey},
		{"HPKE-3-KE/A256GCM", jwa.HPKE_3_KE(), jwa.A256GCM(), x25519Key.PublicKey()},
		{"HPKE-4-KE/A256GCM", jwa.HPKE_4_KE(), jwa.A256GCM(), x25519Key.PublicKey()},
		{"HPKE-7-KE/A256GCM", jwa.HPKE_7_KE(), jwa.A256GCM(), &ecKeyP256.PublicKey},
	}
...
func BenchmarkJWE_Decrypt_HPKE(b *testing.B) {
	if testing.Short() {
		b.Skip("skipping in short mode")
	}
	...
	testcases := []struct {
		...
		{"HPKE-0-KE/A256GCM", jwa.HPKE_0_KE(), jwa.A256GCM(), &ecKeyP256.PublicKey, ecKeyP256},
		{"HPKE-1-KE/A256GCM", jwa.HPKE_1_KE(), jwa.A256GCM(), &ecKeyP384.PublicKey, ecKeyP384},
		{"HPKE-2-KE/A256GCM", jwa.HPKE_2_KE(), jwa.A256GCM(), &ecKeyP521.PublicKey, ecKeyP521},
		{"HPKE-3-KE/A256GCM", jwa.HPKE_3_KE(), jwa.A256GCM(), x25519Key.PublicKey(), x25519Key},
		{"HPKE-4-KE/A256GCM", jwa.HPKE_4_KE(), jwa.A256GCM(), x25519Key.PublicKey(), x25519Key},
		{"HPKE-7-KE/A256GCM", jwa.HPKE_7_KE(), jwa.A256GCM(), &ecKeyP256.PublicKey, ecKeyP256},
	}
